...
_SERVICE_NAME = os.environ.get("SERVICE_NAME", "architect-agent")
_LEVEL_LABELS = {
    "DEBUG": "DEBUG",
    "INFO": "INFO",
    "WARNING": "WARN",
...
app = FastAPI(title="Architect Agent API", lifespan=lifespan)
...
async def log_requests(request: Request, call_next):
    ...
    if request.url.path != "/api/health" and not request.url.path.startswith("/metrics"):
